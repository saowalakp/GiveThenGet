        ...
        <div class="container">
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="probootstra-cta-button last"><a href="login.php" class="btn btn-primary" >Login</a></li>
            </ul>
          </div>
        </div>
      </nav>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                ...
                <p class="probootstrap-animate"><a href="donate_page.php" class="btn btn-primary btn-lg">Donate Now</a></p>
              </div>
            </div>
          </div>
        </div>
